...
public:
    ...
    /// \param wrap GL_CLAMP, GL_REPEAT, GL_NEAREST, GL_LINEAR, GL_NEAREST_MIPMAP_NEAREST, GL_LINEAR_MIPMAP_NEAREST, GL_NEAREST_MIPMAP_LINEAR, GL_LINEAR_MIPMAP_LINEAR
    void addColorTexture(GLuint textureFormat = GL_RGB, GLuint magFilter = GL_LINEAR, GLuint minFilter = GL_LINEAR, GLuint wrap = GL_CLAMP_TO_EDGE);
